...
class TestStrikeMapper(TestCase):
    def setUp(self):
        self.strike_builder = Mock(
            name="strike_builder", spec=blitzortung.builder.Strike
        )
...
class TestStationMapper(TestCase):
    def setUp(self):
        self.station_builder = Mock(
            name="station_builder", spec=blitzortung.builder.Station
        )
