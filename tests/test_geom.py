...
class TestEnvelope(TestCase):
    ...
    def test_contains_point_inside_envelope(self):
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(0, 0)))
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(1, 1.5)))
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(-1, -1.5)))

    def test_contains_point_on_border(self):
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(0, -3)))
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(0, 2)))
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(-5, 0)))
        self.assertTrue(self.envelope.contains(blitzortung.typedef.Point(4, 0)))

    def test_does_not_contain_point_outside_border(self):
        self.assertFalse(self.envelope.contains(blitzortung.typedef.Point(0, -3.0001)))
        self.assertFalse(self.envelope.contains(blitzortung.typedef.Point(0, 2.0001)))
        self.assertFalse(self.envelope.contains(blitzortung.typedef.Point(-5.0001, 0)))
        self.assertFalse(self.envelope.contains(blitzortung.typedef.Point(4.0001, 0)))
